...
export default function TidalEffectCard() {
  ...
  return (
    <CollapsibleCard
      ...
      title="进出港流量对比"
      icon={<ArrowLeftRight size={12} style={{ color: '#4da6ff' }} />}
      summary={summary}
      delay="0.1s"
    >
      ...
      <div style={{ marginBottom: 6 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: '#A0A8B4', marginBottom: 4 }}>
          <span>出港潮</span>
          <span>进港潮</span>
        </div>
      ...
      <div style={{ fontSize: 11, color: '#C9CDD4', marginBottom: 4 }}>
      ...
      <div style={{ fontSize: 11, color: '#A0A8B4', marginTop: 4 }}>
