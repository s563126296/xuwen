...
const defaultCommandState: CommandState = {
  ...
  strategies: [
    {
      id: 'S-01', name: '进港大道 → S376 省道分流', recommended: true, permission: 'confirm', permissionLabel: '🟡 需确认',
      effect: '6.5 → 5.2', time: '约 20 分钟', reduce: '~200 辆', difficulty: 1,
      effectTime: '5 分钟生效', risk: 'S376 沿线居民出行受影响，日常限大车需临时放开',
      triggerCondition: '进港大道车速 < 20km/h 持续 10 分钟',
      status: 'idle',
    },
    {
      id: 'S-02', name: '徐海路 → 环半岛公路分流', recommended: false, permission: 'confirm', permissionLabel: '🟡 需确认',
      effect: '6.0 → 4.5', time: '约 25 分钟', reduce: '~180 辆', difficulty: 1,
      effectTime: '8 分钟生效', risk: '环半岛公路日常限大车，需临时放开小车通行',
  ...
  actualIndex: null,
  historyEffects: [
    { name: 'S-01 进港大道→S376分流', rate: 89, color: '#10B981' },
    { name: 'S-02 徐海路→环半岛公路分流', rate: 76, color: '#00D0E9' },
    { name: 'S-04 徐海路→环半岛公路分流', rate: 62, color: '#F59E0B' },
  ],
  currentStep: 1,
  ...
  historyStats: {
    ...
    avgReliefMinutes: 28,
    top3: [
      { name: 'S-01 进港大道→S376分流', avgMinutes: 22 },
      { name: 'S-02 徐海路→环半岛公路分流', avgMinutes: 26 },
